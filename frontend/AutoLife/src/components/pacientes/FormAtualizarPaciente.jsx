...
import { mapPacienteUpdatePayload } from "../../utils/mapper.jsx";
const { useState, useEffect } = React;
import { PatternFormat } from 'react-number-format';

function FormAtualizarPaciente({ onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = mapPacienteUpdatePayload(formData);

        try {
            const response = await fetch(`${API_BASE_URL}/pacientes/${selectedId}`, {
                method: 'PUT',
                headers: {
    ...
    return (
        <>
            <div className="form-group">
                <label className="form-label">Selecione o paciente para atualizar</label>
                <select
